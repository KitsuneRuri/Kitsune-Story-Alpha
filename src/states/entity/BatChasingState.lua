--[[
    ...
    -- BatChasingState Class --
	
	
]]

BatChasingState = Class{__includes = BaseState}

function BatChasingState:init(entity, player)
	self.entity = entity
    self.player = player
    self.map = entity.map
...
function BatChasingState:update(dt)
    ...
    elseif self.player.x < self.entity.x then
        ...
        self.entity.x = self.entity.x - BAT_MOVE_SPEED * 1.5 * dt
