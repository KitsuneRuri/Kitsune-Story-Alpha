--[[
    ...
    -- SkeletonIdleState Class --

    
]]

SkeletonIdleState = Class{__includes = BaseState}

function SkeletonIdleState:init(entity, player)
	self.entity = entity
    self.player = player
...
function SkeletonIdleState:enter(params)
    self.waitPeriod = params.wait
end

function SkeletonIdleState:update(dt)
