--[[
    ...
    -- PlayerGroundSlashState Class --
	
	
]]

PlayerGroundSlashState = Class{__includes = BaseState}

function PlayerGroundSlashState:init(player)
    self.player = player
...
function PlayerGroundSlashState:update(dt)
